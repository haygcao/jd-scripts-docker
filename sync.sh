...
(
  ...
  git clone https://github.com/haygcao/jd-scripts-docker.git /jd-scripts-docker_tmp
...
(
  ...
  git clone --branch=master https://github.com/LXK9301/jd_scripts.git /scripts_tmp
  [ -d /scripts_tmp ] && {
    rm -rf /scripts
